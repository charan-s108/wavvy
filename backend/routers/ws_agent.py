...
async def _execute_approved_action(
    ...
    try:
        ...
        # Collect any reference numbers generated by this action so the agent
        # can read them to the customer or record them in the case notes.
        _ref_keys = ("inc_number", "res_number", "rfn_number", "dsp_number",
                     "fraud_number", "case_number", "reference_number")
        reference_numbers = {k: result[k] for k in _ref_keys if result.get(k)}
