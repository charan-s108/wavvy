      ...
      >
        <div className="flex items-center justify-between">
          ...
          {!editingPrompt ? (
            <button
              ...
              style={{ background: Wa(0.04), border: `1px solid ${Wa(0.12)}`, color: Wa(0.62) }}
              onMouseEnter={e => { e.currentTarget.style.background = Wa(0.08); e.currentTarget.style.color = '#fff' }}
              onMouseLeave={e => { e.currentTarget.style.background = Wa(0.04); e.currentTarget.style.color = Wa(0.62) }}
            >
              <Edit3 size={11} /> Edit
            </button>
          ) : (
            <div className="flex gap-2">
              ...
              <button
                onClick={() => { setEditingPrompt(false); setPromptDraft(config?.voice_system_prompt || '') }}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[11px] font-medium transition-all"
                style={{ background: Wa(0.04), border: `1px solid ${Wa(0.12)}`, color: Wa(0.55) }}
              >
                <X size={11} /> Cancel
              </button>
            </div>
        ...
        {editingPrompt ? (
          <textarea
            ...
            rows={12}
            className="w-full rounded-xl p-4 text-[12px] resize-y outline-none"
            style={{
              background: Wa(0.03),
          ...
          >
            {config?.voice_system_prompt || '(empty)'}
          </pre>
        )}
      </div>
